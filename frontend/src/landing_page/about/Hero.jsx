  ...
  return (
    <>
      <div className="container text-center my-5">
        ...
        <div className="row border-top border-bottom mt-5 py-4 fs-6" >
            <div className="col"></div>
            <div className="col-4 me-5 text-start mt-5 mb-5" style={{fontSize:"18px"}}>
            ...
            <div className="col-4 text-start mt-5 mb-5" style={{fontSize:"18px"}}>
