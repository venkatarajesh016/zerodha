...
const app = express();
// Allow requests from the frontend and dashboard dev servers and allow credentials (cookies)
...
//             day:item.day,
//         }
//         const holding = new HoldingModel(data);
//         await holding.save();
//     });
...
//     samplePositions.forEach(async (item)=>{
//         let data={
...
//             isLoss:item.isLoss,
//         }  
//         const position = new PositionsModel(data);
//         await position.save();
//     });
